...
/*
*Custom panel with wavy like background
*/
public class WaveBackground extends JPanel {
    ...
    private float animate; //Animation parameter
    private int header = 60; //header height
    private boolean showPaint; // flag to control paint
    ...
    public void paint(Graphics grphcs) {
        ...
        //calculate height based on animation easing functions
        int height = (int) (getHeight() * (1f - easeOutQuint(animate)));
        
        //draw filled shapes with varying colors and heights
        ...
        //draw background rectangle with different color
