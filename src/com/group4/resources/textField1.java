...
/** Custom JTextField with animation effects and rounded background
 * it has animation effect when mouse pressed, it is customizable with color and effects
*/
...
public class textField1 extends JTextField {
    ...
    private float alpha;
    private Color effectColor = new Color(255, 255, 255); //color effect
